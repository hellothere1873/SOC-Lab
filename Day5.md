...
I went through the process of adding that server as a fleet server in the elasticsearch gui through our elasticsearch and kibana server.
...
I set ufw allow 8220 for the fleet server to be able to communicate with the windows agent
