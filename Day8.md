...
After a few restarts of the ubuntu-server and also allowing port 9200 under the ubuntu-server IP through the ELK-stack-server firewall, I am able to get logs of the ubuntu-server through Elasticsearch successfully.
